    ...
    >
      ...
      >
        ...
        <div
          ...
          } fixed z-10 flex-col transition-transform lg:translate-x-0 lg:basis-3/5 duration-300 ease-in  overflow-y-hidden lg:bg-transparent lg:space-y-0 lg:justify-between  lg:items-center space-y-12 lg:relative lg:top-0 lg:my-auto lg:ml-auto lg:flex gap-6 lg:h-fit lg:flex-row lg:overflow-y-visible lg:p-0 lg:align-middle lg:opacity-100
        `}
        >
          {links.map((val) => (
